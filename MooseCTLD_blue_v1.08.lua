...
--%%% CARGO %%%
    ...
    -- MBT
        ...
        -- blueCtld:AddCratesCargo("MBT T-72B3 (4)",{"CTLD MBT T-72B"},CTLD_CARGO.Enum.VEHICLE,4,907.184, nil, "Ground Offensive")
        -- MBT T-90 (modern)
        -- blueCtld:AddCratesCargo("MBT T-90 (4)",{"CTLD MBT T-90"},CTLD_CARGO.Enum.VEHICLE,4,907.184, nil, "Ground Offensive")
    ...
    -- SAM MR
        ...
        blueCtld:AddCratesCargo("SAM MR Hawk (8)",{"CTLD SAM Hawk"},CTLD_CARGO.Enum.VEHICLE,8,907.184, nil, "Surface-to-Air Missile")
...
--%%% FOB %%%
    ...
    function BuildAFARP_blue(Coordinate)
        ...
        UTILS.SpawnFARPAndFunctionalStatics(FName,Coordinate,ENUMS.FARPType.PADSINGLE,blueCtld.coalition,country.id.CJTF_BLUE,FarpNameNumber,FARPFreq,radio.modulation.AM,nil,nil,nil,100,100)
